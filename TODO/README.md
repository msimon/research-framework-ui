...
| 4 | [Source trust score & weight](source-trust-score-and-weight.md) | Per-source authority signal (gov / regulator / press / company-primary / etc.) computed via a small Haiku classification call and cached. Surface as colored bracket / trust badge in the source list. | [ ] | — |
